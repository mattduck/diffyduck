...
- Comments on diffs or commits, automatically stored in git state similar to git-notes
...
99.9% generated, which was the only reason I could get time to do it. This
README is slop-free though.
