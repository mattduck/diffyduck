; Source: github.com/tree-sitter-grammars/tree-sitter-make @ v1.1.1
; Upstream: https://github.com/tree-sitter-grammars/tree-sitter-make/blob/v1.1.1/queries/highlights.scm
;
