; Source: github.com/tree-sitter/tree-sitter-javascript @ v0.25.0
; Upstream: https://github.com/tree-sitter/tree-sitter-javascript/blob/v0.25.0/queries/highlights.scm
;
